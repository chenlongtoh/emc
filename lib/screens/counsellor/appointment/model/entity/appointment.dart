class Appointment {
  ...
  DateTime get getStartTimeAsDate => startTime != null ? DateTime.fromMillisecondsSinceEpoch(startTime) : null;
  DateTime get getendTimeAsDate => endTime != null ? DateTime.fromMillisecondsSinceEpoch(endTime) : null;
